...
from PyQt5.QtWidgets import QWidget, QApplication, QListWidget, QHBoxLayout, QListWidgetItem, QGraphicsView, \
    QGraphicsEllipseItem, QGraphicsScene, QFrame, QLabel
...
class MovingObject2(QtWidgets.QGraphicsPixmapItem):
    def __init__(self):
        super().__init__(QtGui.QPixmap('Knop.png').scaled(64, 64))
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.graphicView = QGraphicsView(self.centralwidget)
        self.graphicView.setAcceptDrops(True)
        ...
        #ADD ITEM 2 TO GRAPHICSVIEW BOX------------------------------------------
        self.scene.addItem(self.movingObject2)

        self.movingObject2.setMargins(self.scene.sceneRect())
